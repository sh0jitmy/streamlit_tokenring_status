...
while True:
    ...
    nodes, edges = parse_csv_data(csv_data)
    ...
    # トークンの位置を更新
    token_position = (token_position + 1) % len(nodes)
    time.sleep(5)  # 5秒ごとにCSVを取得してトークンを移動
